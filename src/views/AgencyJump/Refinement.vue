    ...
    <div class='rc_content'>
      ...
      <div class='rc_right'>
        <div class='r_date'>
          ...
          <div class='p_evaluate' style="float : left; height: 56%;">
      ...
      <div>
        <div style="display: flex; margin: 20px;text-align: center;">
          <div style="width:25%;cursor: pointer;">
            <img class="photo_img" style="width: 30px;height: 37px;" src="@/assets/images/daiban.png" />
            <div class='r_list'>代办(1)</div>
          </div>
          <div style="width:25%;cursor: pointer;">
            <img class="photo_img" style="width: 30px;height: 37px;" src="@/assets/images/rizhi.png" />
            <div class='r_list'>日志(1)</div>
          </div>
          <div style="width:25%;cursor: pointer;">
            <img class="photo_img" style="width: 30px;height: 37px;" src="@/assets/images/jixiao.png" />
            <div class='r_list'>绩效(1)</div>
          </div>
          <div style="width:25%;cursor: pointer;">
            <img class="photo_img" style="width: 30px;height: 37px;" src="@/assets/images/shenpi.png" />
            <div class='r_list'>审批(1)</div>
          </div>
          <div style="width:25%;cursor: pointer;">
            <img class="photo_img" style="width: 30px;height: 37px;" src="@/assets/images/huiyi.png" />
        ...
        <div class='r_attendance'>
          ...
          <div style="display: flex; margin: 20px;text-align: center;">
          <div style="width:25%;cursor: pointer;">
            <img class="photo_img" src="@/assets/images/jiaban.png" />
            <div class='r_list'>加班申请</div>
          </div>
          <div style="width:25%;cursor: pointer;">
            <img class="photo_img" src="@/assets/images/qingjia.png" />
            <div class='r_list'>请假申请</div>
          </div>
          <div style="width:25%;cursor: pointer;">
            <img class="photo_img" src="@/assets/images/buqian.png" />
