...
.login {
  ...
  background: url(../utils/img/2/login_bg_full.png) currentColor no-repeat
    center / cover;
}
.el-input__inner {
...
.focus-username {
  background: rgba(32, 32, 32, 0.2) url(../utils/img/login_user_input.png)
    no-repeat 5% center / auto 45%;
  margin-top: 8%;
}
.focus-password {
  background: rgba(32, 32, 32, 0.2) url(../utils/img/login_password_input.png)
    no-repeat 5% center / auto 45%;
  margin-top: 8%;
}
.l_login {
  background: url(../utils/img/login_commit_button.png) no-repeat center / cover;
