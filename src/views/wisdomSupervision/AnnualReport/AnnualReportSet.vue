...
import { saveMarrageAnnual, saveDeclareExitAnnual,saveRelativesAbroadAnnual } from '@/api/report.js'
...
export default {
  ...
  data() {
    return {
      ...
      reportList2: [
        {saveEvent: 'addMarrageAnnual', label: '本人的婚姻情况', explain: `说明：①首次填报的，应填写婚姻现状，在未婚、已婚、离异、丧偶对应的□内划“√”。②继续填报的，婚姻无变化的，在“无变化”后的□内划“√”；婚姻发生变化的，在结婚、离婚、丧偶、再婚对应的□内划“√”，并填写变化时间。`},
        {saveEvent: '', label: '本人持有普通护照的情况', explain: `说明：①普通护照即因私护照，不含公务普通护照。②首次填报的，无此类情况的，应在“护照号”列下方空格内填写“无”；有此类情况的，应填写填报时的有效普通护照情况，以及上一年1月1日以来截至填报日失效的普通护照情况。③继续填报的，应先在表格右上方“有变化”或“无变化”后的□内划“√”，有变化的在表格内填写变化情况。`},
        {saveEvent: 'addDeclareExitAnnual', label: '本人因私出国的情况', explain: `说明：①填写时，应先在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，首次填报的，填写上一年1月1日以来截至填报日的因私出国情况；继续填报的，填写上次填报以来的因私出国情况。③所到国家应填报从出国至回国期间到过的所有国家，含过境签的国家。④事由主要包括探亲、访友、学术交流、就医、旅游、继承、接受和处理财产等。`},
        {saveEvent: 'addDeclareExitAnnual', label: '本人持有往来港澳通行证、因私持有大陆居民往来台湾通行证的情况', explain: `说明：①首次填报的，无此类情况的，应在“证件名称”列下方空格内填写“无”；有此类情况的，应填写填报时的有效证件情况，以及上一年1月1日以来截至填报日失效的证件情况。②继续填报的，应先在表格右上方“有变化”或“无变化”后的□内划“√”，有变化的在表格内填写变化情况。`},
        {saveEvent: 'addDeclareExitAnnual', label: '本人因私往来港澳、台湾的情况', explain: `说明：①填写时，应先在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，首次填报的，填写上一年1月1日以来截至填报日因私往来港澳、台湾的情况；继续填报的，填写上次填报以来因私往来港澳、台湾的情况。③事由主要包括探亲、访友、学术交流、就医、旅游、继承、接受和处理财产等。`},
        {saveEvent: 'addMarrageAnnual', label: '子女与外国人、无国籍人通婚的情况', explain: `说明：①首次填报的，无此类情况的，应在“子女姓名”列下方空白处填写“无”；有此类情况的，应填写现状。②继续填报的，应先在表格右上方“有变化”或“无变化”后的□内划“√”，有变化的在表格内填写变化情况。`},
        {saveEvent: 'addMarrageAnnual', label: '子女与港澳以及台湾居民通婚的情况', explain: `说明：①首次填报的，无此类情况的，应在“子女姓名”列下方空白处填写“无”；有此类情况的，应填写现状。②继续填报的，应先在表格右上方“有变化”或“无变化”后的□内划“√”，有变化的在表格内填写变化情况。`},
        {saveEvent: 'addRelativesAbroadAnnual', label: '配偶、子女移居国（境）外的情况', explain: `说明：①首次填报的，无此类情况的，应在“姓名”列下方空白处填写“无”；有此类情况的，应填写现状。②继续填报的，应先在表格右上方“有变化”或“无变化”后的□内划“√”，有变化的在表格内填写变化情况。③“移居国（境）外”是指取得外国国籍或者获取国（境）外永久居留资格、长期居留许可等情况。④配偶、子女原本就是外国公民或者香港、澳门、台湾居民的，也属于“移居国（境）外”情形。⑤应报告配偶和子女均已移居国（境）外的情况，也应报告配偶、子女中任何一人已移居国（境）外的情况。⑥“备注”栏填写移居国（境）外的变化情况，比如“已放弃”“无法放弃但已被列为公安机关登记备案人员”等。`},
        {saveEvent: '', label: '配偶、子女虽未移居国（境）外，但连续在国（境）外工作、生活一年以上的情况', explain: `说明：①首次填报的，无此类情况的，应在“姓名”列下方空白处填写“无”；有此类情况的，应填写现状。②继续填报的，应先在表格右上方“有变化”或“无变化”后的□内划“√”，有变化的在表格内填写变化情况。③配偶、子女“虽未移居国（境）外，但连续在国（境）外工作、生活一年以上”是指干部的配偶、子女虽然没有取得外国国籍或者获取国（境）外永久居留资格、长期居留许可，但截至填报日连续在国（境）外工作、生活（含留学）一年以上的情况。④在国（境）外工作、生活期间，因探亲、旅行、出差等短期回国（入境）的，仍视为连续在国（境）外工作、生活。`},
        {saveEvent: '', label: '配偶、子女及其配偶从业情况', explain: `说明：①首次填报的，应填写现状。②继续填报的，应先在表格右上方“有变化”或“无变化”后的□内划“√”，有变化的在表格内填写变化情况。子女无配偶的，应在“配偶姓名”列下方空格内填写“无”。③未从业人员应填写就读情况、学龄前或待业等；退休人员应填写退休前工作单位及原任职务，退休后再就业的，再就业情况一并填写。④持有居民身份证的，填写18位公民身份证号码；同时持有军官证等其他证件的，证件情况填写在“个人认为需要报告的其他事项”栏。⑤受聘担任私营企业高级职务，或在外商投资企业、在中国境内从事生产经营活动的外国（地区）企业、以及外国（地区）企业常驻境内代表机构、境外非政府组织在境内设立的代表机构中担任由外方委派、聘任的高级职务的，需在“是否担任高级职务”栏“是”后的□内划“√”。⑥外商投资企业（含港澳台地区投资企业），包括外商独资企业、中外合资经营企业和中外合作经营企业。⑦关于“高级职务”，对上市公司，以公司章程对经营管理层的具体设定为准；对具有独立法人资格的非上市企业，以其章程对经营管理层的具体设定为准。“高级职务”一般包括：法定代表人、正副董事长、董事、监事、正副经理（总裁）、总会计师（财务总监）、上市公司董事会秘书等，以及外国（地区）企业常驻代表机构、境外非政府组织境内代表机构的首席代表、代表。`},
        {saveEvent: '', label: '配偶、子女及其配偶被司法机关追究刑事责任的情况', explain: `说明：①填写时，应在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，填写截至填报日配偶、子女及其配偶被追究刑事责任的情况。`},
      ],
      reportList3: [
        {saveEvent: '', label: '本人的工资及各类奖金、津贴、补贴等（万元/全年）', explain: `说明：①应填报本人上一年（1月1日至12月31日）扣除所得税、养老保险、医疗保险、职业年金等后的工资及各类奖金、津贴、补贴等全年实际所得的情况。②住房公积金包括个人缴纳部分和单位缴纳部分，计入工资收入。`},
        {saveEvent: '', label: '本人从事讲学、写作、咨询、审稿、书画等劳务所得（万元/全年）', explain: `说明：①无此类情况的，在“无此类情况”后的□内划“√”。②有此类情况的，应先在表格右上方“有此类情况”后的□内划“√”，再填报本人上一年（1月1日至12月31日）扣除所得税后的讲学、写作、咨询、审稿、书画等劳务所得的情况，并填写具体金额。`},
        ...
        {saveEvent: '', label: '本人、配偶、共同生活的子女投资或者以其他方式持有股票的情况', explain: `说明：①填报时，应先在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，应逐人、逐只填写持有的所有股票的名称或代码、持股数量、填报前一交易日收盘时的市值（市值=单只持股数量×收盘时股价），并合计填写填报前一交易日所有股票的总市值。③通过“港股通”购买的股票，也需要填报。开通融资融券账户购买的股票，应当在“备注”栏注明融资融券使用额度等情况。④在国（境）外（包括香港、澳门、台湾）的持有股票情况，填写在“国（境）外的投资情况”事项中。⑤持有非上市公司股份的情况应在“备注”栏注明。`},
        {saveEvent: '', label: '本人、配偶、共同生活的子女投资或者以其他方式持有基金的情况', explain: `说明：①填报时，应先在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，应逐人、逐只填写持有的所有基金的名称或代码、份额、填报前一交易日收盘时的净值（净值=单只基金份数×收盘时单位净值），并合计填写填报前一交易日所有基金的总净值。③通过证券公司、商业银行、互联网等各类基金销售机构购买的理财产品中属于基金的产品（含以理财形式为名的各种形式的集合资产管理计划），均需填报。④在国（境）外（包括香港、澳门、台湾）的持有基金情况，填写在“国（境）外的投资情况”事项中。`},
        ...
        {saveEvent: '', label: '配偶、子女及其配偶经商办企业的情况', explain: `说明：①首次填报的，有此类情况的，应填写截至填报日的现状；无此类情况的，在表格的“姓名”栏内填写“无”。②继续填报的，应先在表格右上方“有变化”和“无变化”后的□内划“√”，有变化的在表格内填写变化情况。③企业或市场主体名称发生变化的，须在“备注”栏注明原名称。注册地填写到市（地、州、盟）。经营地填写到省（区、市）或市（地、州、盟），可填多个区域。④填写时，应按照工商（市场监管）部门登记的最新情况逐项填写。股份有限公司、有限责任公司应填报个人认缴出资额，个体工商户、个人独资企业、合伙企业等应填报个人出资额，而非实际出资额。⑤未开展经营活动的、已经停止经营活动的、被吊销营业执照但未办理注销手续的企业，应当进行报告。`},
        {saveEvent: '', label: '本人、配偶、共同生活的子女在国（境）外的存款情况', explain: `说明：①填报时，应先在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，应当逐人、逐账户填写填报时在国（境）外的国家或者地区（包括香港、澳门、台湾）的银行业金融机构的存款情况，包括人民币和外币。③在国（境）外中资银行及其分支机构的存款属于国（境）外的存款，需要报告。在我国境内设立的外资银行及其分支机构的存款不属于国（境）外存款，不需要报告。`},
        {saveEvent: '', label: '本人、配偶、共同生活的子女在国（境）外的投资情况', explain: `说明：①填报时，应先在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，应逐人、逐项填写填报时在国（境）外（包括香港、澳门、台湾）的投资情况，包括房产，投资或以其他方式持有股票、基金、投资型保险等情况。`},
        {saveEvent: '', label: '本人、配偶、共同生活的子女参与民间借贷的情况', explain: `说明：①填报时，应先在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，应逐人、逐项填写填报时参与民间借贷的情况。③银行贷款、公积金贷款情况不需填报。`},
      ],
      reportList4: [
        {
          label: '个人认为需要报告的其他事项', 
  ...
  methods: {
    ...
    // 保存新增编辑信息
    editDataSave(index,data,saveEvent){
      if(saveEvent.saveEvent == null || saveEvent.saveEvent == ''){
        return
      }
      const flowProcess = {
      ...
      if(data == null){
        ...
        //   this[saveEvent.saveEvent](index, obj)
        // })
        const param = data[0]
        param.flowProcessDto = flowProcess
        this[saveEvent.saveEvent](index, param)
        
      }else{
        // console.log('修改数据', data)
        data.flowProcessDto = flowProcess
        this[saveEvent.saveEvent](index, data)
      }
    },
    // 1. 本人婚姻情况
    addMarrageAnnual(index, param){
      console.log('1. 本人婚姻情况')
    ...
    successOperation(index,res){
      if(res.success) {
        ...
        if(tableData1[index].headerParam != null){
          tableData1[index].headerParam.edit = false
        }else{
