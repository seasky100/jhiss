  ...
  data() {
    return {
      ...
      reportList2: [
        ...
        {saveEvent: '', code:302, label: '本人持有普通护照的情况', explain: `说明：①普通护照即因私护照，不含公务普通护照。②首次填报的，无此类情况的，应在“护照号”列下方空格内填写“无”；有此类情况的，应填写填报时的有效普通护照情况，以及上一年1月1日以来截至填报日失效的普通护照情况。③继续填报的，应先在表格右上方“有变化”或“无变化”后的□内划“√”，有变化的在表格内填写变化情况。`},
