  ...
  data() {
    return {
      ...
      reportList2: [
        ...
        {saveEvent: 'addRelativesIllegalAnnual', label: '配偶、子女及其配偶被司法机关追究刑事责任的情况', explain: `说明：①填写时，应在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，填写截至填报日配偶、子女及其配偶被追究刑事责任的情况。`},
      ],
      reportList3: [
        ...
        {saveEvent: 'addOverseasDepositAnnual', label: '本人、配偶、共同生活的子女在国（境）外的存款情况', explain: `说明：①填报时，应先在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，应当逐人、逐账户填写填报时在国（境）外的国家或者地区（包括香港、澳门、台湾）的银行业金融机构的存款情况，包括人民币和外币。③在国（境）外中资银行及其分支机构的存款属于国（境）外的存款，需要报告。在我国境内设立的外资银行及其分支机构的存款不属于国（境）外存款，不需要报告。`},
        {saveEvent: 'addOverseasInvestmentAnnual', label: '本人、配偶、共同生活的子女在国（境）外的投资情况', explain: `说明：①填报时，应先在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，应逐人、逐项填写填报时在国（境）外（包括香港、澳门、台湾）的投资情况，包括房产，投资或以其他方式持有股票、基金、投资型保险等情况。`},
        {saveEvent: 'addSecuredLoanAnnual', label: '本人、配偶、共同生活的子女参与民间借贷的情况', explain: `说明：①填报时，应先在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，应逐人、逐项填写填报时参与民间借贷的情况。③银行贷款、公积金贷款情况不需填报。`},
      ],
      reportList4: [
        {
          label: '个人认为需要报告的其他事项', 
      ...
      if(res.success) {
        ...
        if(index < 11){
          ...
          if(tableData2[index].headerParam != null){
            tableData2[index].headerParam.edit = false
          }else{
