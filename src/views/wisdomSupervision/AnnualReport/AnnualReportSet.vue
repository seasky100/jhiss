  ...
  data() {
    return {
      ...
      reportList2: [
        ...
        {saveEvent: '', label: '本人持有往来港澳通行证、因私持有大陆居民往来台湾通行证的情况', explain: `说明：①首次填报的，无此类情况的，应在“证件名称”列下方空格内填写“无”；有此类情况的，应填写填报时的有效证件情况，以及上一年1月1日以来截至填报日失效的证件情况。②继续填报的，应先在表格右上方“有变化”或“无变化”后的□内划“√”，有变化的在表格内填写变化情况。`},
        {saveEvent: '', label: '本人因私往来港澳、台湾的情况', explain: `说明：①填写时，应先在表格右上方“有此类情况”或“无此类情况”后的□内划“√”。②有此类情况的，首次填报的，填写上一年1月1日以来截至填报日因私往来港澳、台湾的情况；继续填报的，填写上次填报以来因私往来港澳、台湾的情况。③事由主要包括探亲、访友、学术交流、就医、旅游、继承、接受和处理财产等。`},
        {saveEvent: '', label: '子女与外国人、无国籍人通婚的情况', explain: `说明：①首次填报的，无此类情况的，应在“子女姓名”列下方空白处填写“无”；有此类情况的，应填写现状。②继续填报的，应先在表格右上方“有变化”或“无变化”后的□内划“√”，有变化的在表格内填写变化情况。`},
        {saveEvent: '', label: '子女与港澳以及台湾居民通婚的情况', explain: `说明：①首次填报的，无此类情况的，应在“子女姓名”列下方空白处填写“无”；有此类情况的，应填写现状。②继续填报的，应先在表格右上方“有变化”或“无变化”后的□内划“√”，有变化的在表格内填写变化情况。`},
